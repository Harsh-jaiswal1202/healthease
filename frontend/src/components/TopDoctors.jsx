...
const TopDoctors = () => {
  ...
  return (
    <div 
      ref={containerRef}
      className='flex flex-col items-center gap-6 my-20 text-[#262626] dark:text-gray-200 relative overflow-hidden px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 bg-white dark:bg-gray-900 transition-colors duration-300'
    >
      {/* Animated Background */}
      ...
      <div ref={titleRef} className="text-center z-10">
      ...
      <motion.button 
        ...
        className='bg-gradient-to-r from-primary to-purple-600 text-white px-12 py-4 rounded-full mt-10 font-semibold shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden group'
