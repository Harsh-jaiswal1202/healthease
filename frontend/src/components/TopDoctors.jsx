...
const TopDoctors = ({ compact = false }) => {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      // Only run animations if screen width is > 768px (md breakpoint)
            ...
            >
              ...
              >
                ...
                <div className="relative overflow-hidden bg-gradient-to-br from-[#EAEFFF] to-blue-50">
                  ...
                  {/* Status badge */}
                  <motion.div
                    className={`absolute top-3 right-3 px-3 py-1 rounded-full text-xs font-semibold backdrop-blur-md ${item.available
