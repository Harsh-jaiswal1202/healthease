...
const About = () => {
  ...
  return (
    <div className='relative overflow-hidden'>
      ...
      <section className='rounded-3xl border border-slate-200/70 dark:border-gray-800/70 bg-white/90 dark:bg-gray-900/80 p-6 sm:p-10 shadow-[0_20px_60px_-35px_rgba(15,23,42,0.5)]'>
        <button
        ...
        <div className='flex flex-col lg:flex-row gap-10 items-center'>
          <div className='flex-1'>
            ...
            <h1 className='text-3xl sm:text-4xl font-semibold text-slate-900 dark:text-white mt-2'>Care that feels effortless</h1>
      ...
      <section className='mt-10 rounded-3xl border border-slate-200/70 dark:border-gray-800/70 bg-white/90 dark:bg-gray-900/80 p-6 sm:p-8 shadow-[0_20px_60px_-35px_rgba(15,23,42,0.5)]'>
