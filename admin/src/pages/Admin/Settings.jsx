...
const Settings = () => {
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      const { data } = await axios.post(
        backendUrl + '/api/admin/delete-account',
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] bg-gradient-to-br from-slate-50 via-indigo-50 to-emerald-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 px-4 sm:px-6 lg:px-10 py-8">
      <div className="max-w-5xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-2">
              Update admin email, password, or remove the admin account.
            </p>
          </div>
        ...
        <div className="grid gap-6">
          <section className="bg-white/90 dark:bg-slate-900/80 backdrop-blur border border-slate-200/60 dark:border-slate-800/60 rounded-3xl shadow-[0_18px_60px_-40px_rgba(15,23,42,0.5)] p-6">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                  Toggle between light and dark theme for the admin panel.
                </p>
              </div>
          ...
          <section className="bg-white/90 dark:bg-slate-900/80 backdrop-blur border border-slate-200/60 dark:border-slate-800/60 rounded-3xl shadow-[0_18px_60px_-40px_rgba(15,23,42,0.5)] p-6">
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                  This email is used for admin notifications.
                </p>
              </div>
              <div className="h-11 w-11 rounded-2xl bg-gradient-to-br from-primary/15 to-cyan-500/15 flex items-center justify-center text-primary">
                @
          ...
          <section className="relative overflow-hidden bg-gradient-to-br from-red-50 via-white to-rose-50 dark:from-slate-900 dark:via-slate-900 dark:to-slate-950 border border-rose-200/60 dark:border-rose-900/40 rounded-3xl shadow-[0_18px_60px_-40px_rgba(190,18,60,0.35)] p-6">
            ...
            <div className="relative flex items-start justify-between gap-4">
              <div>
                ...
                <h2 className="text-xl font-semibold text-slate-900 dark:text-white mt-2">
                  Permanently remove the admin account
                </h2>
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                  This action is irreversible. The admin record will be deleted.
                </p>
              </div>
            ...
            <div className="mt-5 grid gap-4 md:grid-cols-2 items-end">
              <div>
                ...
                <label className="mt-3 text-sm text-slate-600 dark:text-slate-300 flex items-center gap-2">
                  ...
                  />
                  I understand this will delete the admin account.
                </label>
              </div>
          ...
          <div className="relative mx-4 w-full max-w-md rounded-3xl bg-white/95 dark:bg-slate-900/95 border border-slate-200/60 dark:border-slate-800/60 shadow-[0_20px_60px_-30px_rgba(15,23,42,0.6)] p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                  Update your admin email to <span className="font-semibold text-slate-700 dark:text-slate-200">{email}</span>?
                </p>
              </div>
            </div>
        ...
        <div className="fixed inset-0 z-[9999] grid place-items-center">
          ...
          <div className="relative mx-4 w-full max-w-md rounded-3xl bg-white/95 dark:bg-slate-900/95 border border-rose-200/60 dark:border-rose-900/40 shadow-[0_20px_60px_-30px_rgba(190,18,60,0.45)] p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-slate-900 dark:text-white">Delete admin account?</h3>
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                  This action is permanent. The admin record will be removed.
                </p>
              </div>
            </div>
            <div className="mt-6 flex flex-col sm:flex-row gap-3 sm:justify-end">
